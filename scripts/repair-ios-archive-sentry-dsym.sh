...
usage() {
  cat <<'USAGE'
Usage:
  scripts/repair-ios-archive-sentry-dsym.sh --archive <MomentsAV.xcarchive>

Generates the dSYM for Xcode's Sentry.framework stub inside a Moments AV iOS
...
sentry_binary="$archive_path/Products/Applications/MomentsAV.app/Frameworks/Sentry.framework/Sentry"
