...
profile="${MOMENTSAV_INFISICAL_PROFILE:-local}"
if [ "${1:-}" = "--profile" ]; then
  profile="${2:-}"
  shift 2
fi
...
export_from_varlock "MOMENTSAV_API_BASE_URL" "VITE_MOMENTSAV_API_BASE_URL"
export_from_varlock "MOMENTSAV_CONVEX_URL" "VITE_MOMENTSAV_CONVEX_URL" optional
export_from_varlock "MOMENTSAV_TERMS_URL" "VITE_MOMENTSAV_TERMS_URL" optional
export_from_varlock "MOMENTSAV_PRIVACY_URL" "VITE_MOMENTSAV_PRIVACY_URL" optional
export_from_varlock "MOMENTSAV_WEBAPP_COMING_SOON" "VITE_MOMENTSAV_WEBAPP_COMING_SOON" optional
...
export_from_varlock "MOMENTSAV_SUPPORT_EMAIL" "VITE_MOMENTSAV_SUPPORT_EMAIL" optional
export_from_varlock "MOMENTSAV_OPEN_SOURCE_URL" "VITE_MOMENTSAV_OPEN_SOURCE_URL" optional
