...
struct MomentsAccountDeletionPolicy {
    struct Copy {
    ...
    static func canUnlinkCurrentApp(from summary: AccountSummary, currentAppId: String = "momentsav", suiteAppId: String = "avapps") -> Bool {
    ...
    static func conservativeEligibility(
        ...
        return AccountDeletionEligibility(status: blockers.isEmpty ? .eligible : .blocked, blockers: blockers, warnings: warnings, currentJob: summary.currentDeletionJob)
    }
