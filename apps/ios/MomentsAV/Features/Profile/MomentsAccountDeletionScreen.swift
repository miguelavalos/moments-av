...
struct MomentsAccountDeletionScreen: View {
    @Environment(\.dismiss) private var dismiss
    @StateObject private var viewModel: MomentsAccountDeletionViewModel

    init(viewModel: MomentsAccountDeletionViewModel) {
    ...
    private var accountWebsiteLink: some View {
    ...
    private func blockerDetail(for blocker: AccountDeletionBlocker) -> String? {
        ...
        case .deletionInProgress, .linkedApp, .activeAiCredits, .activeProAccess, .activeBillingSubscription, .identityProvider:
